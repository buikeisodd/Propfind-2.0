...
export default function InteractiveMap({
  ...
  return (
    <div
      className="relative w-full overflow-hidden rounded-2xl bg-slate-900 border border-slate-800 text-white shadow-xl flex flex-col h-[320px] sm:h-[480px]"
    ...
    >
      ...
      >
        ...
        <div className="flex gap-2 pointer-events-auto">
          ...
          >
            ...
            <span>
              {isLassoDrawing ? "Drawing Lasso..." : "Draw Search Area"}
            </span>
          </button>
      ...
      <div className="w-full flex-1 relative cursor-grab active:cursor-grabbing overflow-hidden">
        ...
        >
          ...
          >
            ...
            <path
              d="M0,0 L250,0 L200,180 L0,150 Z"
              fill="#9a3412"
              fillOpacity="0.1"
              stroke="#ea580c"
              strokeWidth="1.5"
            ...
            <path
              d="M250,0 L500,0 L500,220 L280,180 Z"
              fill="#166534"
              fillOpacity="0.15"
              stroke="#16a34a"
              strokeWidth="1.5"
            ...
            <path
              d="M100,180 L280,180 L350,300 L90,300 Z"
              fill="#374151"
              fillOpacity="0.25"
              stroke="#4b5563"
              strokeWidth="2"
            ...
            <text
              ...
              y="280"
              fill="#94a3b8"
              className="text-[10px] font-mono tracking-widest text-center font-bold"
            >
              DOWNTOWN METRO
            </text>
            ...
            <path
              d="M0,150 L200,180 L300,320 M0,150 L100,280 L0,380 Z"
              fill="#0369a1"
              fillOpacity="0.15"
            />
            <path
              d="M0,280 Q80,240 180,300 T300,400"
              fill="none"
              stroke="#38bdf8"
              strokeWidth="3"
              strokeOpacity="0.6"
            ...
            <path
              d="M300,300 L500,220 L500,400 L300,400 Z"
              fill="#581c87"
              fillOpacity="0.1"
              stroke="#8b5cf6"
              strokeWidth="1.5"
            ...
            {properties.map((prop) => {
              ...
              return (
                ...
                >
                  ...
                  <MapPin
                    className={`w-3.5 h-3.5 absolute -translate-x-1.75 -translate-y-1.75 pointer-events-none ${
                      isSelected
                        ? "text-white"
                        : prop.isPromoted
                  ...
                  {(isHovered || isSelected) && (
                    ...
                    >
                      <div className="bg-slate-950/95 border border-slate-700/80 p-1.5 rounded-lg shadow-2xl text-[9px] text-center backdrop-blur-sm">
                        <p className="font-semibold text-white truncate px-1">
                          {prop.title}
                        </p>
        ...
        {isLassoDrawing && (
          ...
          >
            <div className="bg-amber-500/90 text-amber-980 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-lg flex items-center gap-1.5 backdrop-blur-sm animate-pulse">
              ...
              <span>
                Right-Click/Drag on map coordinates to draw and encircle
      ...
      {/* Map Legend Footer */}
      <div
        className="bg-slate-950/50 border-t border-slate-800 p-2.5 px-4 text-[10px] text-slate-400 flex items-center justify-between"
        id="map-legend"
      >
        <div className="flex gap-4 items-center">
          ...
          <span className="flex items-center gap-1">
            <span className="w-2.5 h-2.5 rounded-full bg-slate-800 border border-slate-400" />{" "}
            Standard
          </span>
        </div>
